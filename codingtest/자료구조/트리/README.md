...
* 사용처 : 이진트리(Binary Tree) 형태의 구조로 탐색 알고리즘 구현을 위해 많이 사용된다.
...
### 4.1 이진트리와 정렬된 배열간의 탐색 비교
<img src="https://www.mathwarehouse.com/programming/images/binary-search-tree/binary-search-tree-sorted-array-animation.gif" />

(출처: https://www.mathwarehouse.com/programming/gifs/binary-search-tree.php#binary-search-tree-insertion-node)

### 4.2 이진탐색트리의 시간 복잡도와 단점
...
#### 5.4.4 이진탐색트리 삭제 함수 구현

* ```delete 함수 추가```
* 삭제할 Node가 없는 경우에도 처리해줘야한다.
    - 이를 위해 삭제할 Node가 없는 경우는 Fasle를 리턴하고, 함수를 종료시킨다.
...
##### 5.4.4.1 CASE1 : 삭제할 Nodel가 단말노드인 경우
...
##### 5.4.4.2 CASE2 : 삭제할 Node가 자식노드를 한 개 가지고 있을 경우
...
##### 5.4.4.3 CASE3 : 삭제할 Node가 자식노드를 두개 가지고 있을 경우

* CASE3-1: 삭제할 노드가 부모노드의 왼쪽에 있을경우
...
* CASE3-2: 삭제할 노드가 부모노드의 오른쪽에 있을경우
    * 기본 사용 가능 전략
    1. **삭제할 Node의 오른쪽 자식 중, 가장 작은 값을 삭제할 Node의 Parent Node가 가리키도록 한다.**
    2. 삭제할 Node의 왼쪽 자식 중, 가장 큰 값을 삭제할 Node의 Parent Node가 가리키도록 한다.
    * 기본 사용 가능 전략 중, 1번 전략을 사용하여 코드를 구현하기로 함
